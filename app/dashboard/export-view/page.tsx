          ...
          <div className="space-y-6 p-6">
            ...
            <div className="rounded-3xl border border-sky-200 bg-sky-50 p-5">
              <p className="text-sm font-bold text-sky-800">
                ช่วงวันที่นี้อิงจาก "วันที่ของรายการ"
              </p>

              <p className="mt-1 text-sm leading-6 text-slate-600">
                เช่น วันที่จะ OT / วันที่จะเปลี่ยนกะ /
                วันที่เริ่มลา — ไม่ใช่วันที่พนักงานกดส่งคำขอ
                ตัวอย่าง: พนักงานกรอกคำขอวันที่ 18/8/69
                แต่ต้องการเปลี่ยนกะวันที่ 15/8/69
                ให้เลือกช่วงวันที่ที่ครอบคลุม 15/8/69
                ระบบจะดึงรายการนี้มาให้
              </p>
            </div>
